...
$req = $pdo->prepare('SELECT films.id,films.title,films.synopsis,users.username,films.id_user FROM films, users WHERE films.id_user=users.id AND films.id_user=?'); 
